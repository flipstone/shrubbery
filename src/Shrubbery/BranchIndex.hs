...
import Shrubbery.TypeList (AppendTypes, FirstIndexOf, TypeAtIndex, ZippedTypes, KnownLength(lengthOfTypes))
...
-}
appendTypesToIndex :: BranchIndex t types
                   -> Proxy moreTypes
...
{-|
  ...
  same.
-}
prependTypesToIndex :: KnownLength moreTypes
                    => BranchIndex t types
                    -> Proxy moreTypes
...
{- |
  ...
  section of the list.
-}
splitIndex :: forall typesA typesB t.
              KnownLength typesA
